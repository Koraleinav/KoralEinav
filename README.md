...
### [Zvovon](https://github.com/Koraleinav/Zvovon)
A project aimed at [brief description of Zvovon]. This project showcases my skills in [technologies used].

### [Koral](https://github.com/alphabestteam/Koral)
Developed as part of the AlphaBestTeam, Koral is [brief description]. My contributions included [specific contributions].

### [The Hero Game](https://github.com/Koraleinav/The-Hero-Game)
A freelance project where I [brief description]. This project highlights my abilities in [technologies or methodologies used].

### [AI Tic-Tac-Toe](https://github.com/Koraleinav/AI_Tic-Tac-Toe)
An AI-driven Tic-Tac-Toe game that [brief description]. Demonstrates my interest and skills in AI concepts and TypeScript.
